          ...
          <div className="p-5 rounded-2xl bg-emerald-500/5 border border-emerald-500/20 flex gap-4 items-start">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
                Als Schülerin oder Schüler nutzen Sie diesen CO₂-Rechner vollständig anonym. Der Zugangscode (Access Key) ist ein zufällig generiertes Zeichen-Token. Es werden keine Namen, IP-Adressen oder sonstigen Identifikatoren gespeichert, die Sie persönlich identifizieren könnten.
              </p>
            </div>
          </div>
